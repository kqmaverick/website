...
ClusterTool is available on [GitHub](https://github.com/truecharts/clustertool-public/tags). Please extract the archive and copy the executable into your `configuration folder`.
